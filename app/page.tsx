...
const GlowingButton: React.FC<{ href: string; className?: string; children: React.ReactNode }> = ({
  href,
  className,
  children,
}) => (
  <Link
    href={href}
    className={`inline-flex items-center px-6 py-3 rounded-full text-white font-medium relative overflow-hidden group ${className}`}
  >
    <span className="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-600 opacity-80 group-hover:opacity-100 transition-opacity duration-300"></span>
    <span className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 opacity-0 group-hover:opacity-80 transition-opacity duration-300"></span>
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0C1B] text-white font-inter overflow-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6">
          <div className="flex items-center gap-4">
            ...
            />
            <span className="text-xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 bg-clip-text text-transparent animate-gradient-x">
              GW2
            </span>
          </div>

          <nav className="hidden md:flex items-center space-x-8">
            {["Inicio", "Eventos", "VIP", "Comunidad"].map((item) => (
              <a
                key={item}
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden" id="inicio">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center px-6 pt-24">
          <motion.h1
            className="text-6xl md:text-7xl font-black mb-6 bg-gradient-to-r from-white via-blue-300 to-blue-500 bg-clip-text text-transparent animate-gradient-x"
          ...
          >
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <FaChevronDown className="text-blue-400 animate-bounce w-6 h-6" />
            </div>
          </motion.div>
        </div>
      </section>
                ...
                <div className="relative backdrop-blur-sm bg-gray-900/80 rounded-3xl p-8 text-center transform hover:-translate-y-2 transition-all duration-500 border border-gray-700/50">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="relative">
                      ...
                      <span
                        className={`text-2xl font-bold bg-gradient-to-r ${stat.gradient} text-transparent bg-clip-text ml-1`}
                      >
                        {stat.suffix}
                      </span>
                    </div>
            ...
            {reviews.map((review, index) => (
              ...
              >
                ...
                <div className="flex items-center">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <FaStar key={star} className={`${star <= review.rating ? "text-yellow-400" : "text-gray-400"}`} />
                  ))}
                </div>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="relative" data-aos="zoom-in">
            ...
            <div className="relative bg-gray-800/50 backdrop-blur-sm rounded-2xl p-4 shadow-2xl">
              <div className="rounded-xl overflow-hidden" style={{ width: "100%", height: "600px" }}>
                <iframe
            ...
            {[
              {
                ...
                style: "border-yellow-500/20 bg-gradient-to-b from-yellow-950 to-gray-900/95",
              ...
              },
              {
                ...
                style: "border-blue-500/20 bg-gradient-to-b from-blue-950 to-gray-900/95",
              ...
              },
              {
                ...
                style: "border-red-500/20 bg-gradient-to-b from-red-950 to-gray-900/95",
                nameStyle: "text-red-400",
                buttonStyle: "bg-red-950 hover:bg-red-900 text-red-400",
                link: "https://www.patreon.com/checkout/GW2?rid=24031434",
              },
            ].map((tier, index) => (
              <Card key={index} className={`relative border ${tier.style} backdrop-blur-sm flex flex-col`}>
                {tier.popular && (
                  <Badge className="absolute -top-3 left-1/2 -translate-x-1/2 bg-pink-500">LO MÁS POPULAR</Badge>
                )}
                <CardHeader>
                  <h3 className={`text-3xl font-bold text-center ${tier.nameStyle}`}>{tier.name}</h3>
                </CardHeader>
                <CardContent className="space-y-6 flex-grow">
                  <div className="text-center">
                    <span className={`text-4xl font-bold ${tier.nameStyle}`}>${tier.price}</span>
                ...
                <CardFooter className="mt-auto">
                  <Button className={`w-full ${tier.buttonStyle}`} onClick={() => window.open(tier.link, "_blank")}>
                    Súmate
                  </Button>
                </CardFooter>
              </Card>
      ...
      <footer className="py-16 bg-gray-900/80 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Inicio", "Sobre Nosotros", "Eventos", "Reseñas"].map((item) => (
                  <li key={item}>
                    <Link
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4 text-white">Comunidad</h4>
              <ul className="space-y-2">
                {["FAQ", "Soporte", "Contacto", "Reglas"].map((item) => (
                  <li key={item}>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 text-center">
            <p className="text-gray-400">&copy; {new Date().getFullYear()} GW2 | Todos los derechos reservados</p>
            <p className="text-gray-400 mt-4">
              <span>&#60;&#47;&#62;</span> Codificado por
              <a
                href="https://github.com/junsred"
                target="_blank"
                rel="noopener noreferrer"
